...
class InlineObject3 implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPINullables = [
        ...
        'double' => false,
        'string' => false,
        'pattern_without_delimiter' => false,
        'byte' => false,
        'binary' => false,
        'date' => false,
        'date_time' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('pattern_without_delimiter', $data, null);
    ...
    public function setPatternWithoutDelimiter($pattern_without_delimiter)
    {
        ...
        if (is_null($pattern_without_delimiter)) {
            throw new \InvalidArgumentException('non-nullable pattern_without_delimiter cannot be null');
        }
